...
{
    internal class LogDateTimeContainer : LogContainer
    {
        internal DateTime ValueTyped { get; init; }
        ...
        {
            if (theValue is DateTime aValue)
            {
                return aValue == ValueTyped;
            }

            if (DateTime.TryParse(theValue.ToString(), out aValue))
            {
                return aValue == ValueTyped;
            }
